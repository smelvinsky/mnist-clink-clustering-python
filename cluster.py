...
def get_distance(cluster_1: MnistCluster, cluster_2: MnistCluster):
    """
    Function which calculates distance between two clusters with single-linkage method.
...
def recognize_cluster(reference_clusters, test_cluster: MnistCluster):
    ...
    :param test_cluster:
    :return: list of recognized digits (list in case of having a few the same values)
    """
